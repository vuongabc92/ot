...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function(){
    ...
    Route::get('/p/{id}/delete/{token}', ['as' => 'backend_post_delete', 'uses' => 'PostController@delete']);
    Route::post('/p/{slug}/save', ['as' => 'backend_post_save', 'uses' => 'PostController@save']);
    Route::get('/post/{id}/toggle-show-hide', ['as' => 'backend_post_active', 'uses' => 'PostController@toggleShowHide']);
});
